...
class TestApiMemesNegative:
    ...
    def test_get_authorize_token_negative_auth(self, get_authorize_token, invalid_token):
    ...
    @pytest.mark.parametrize("invalid_token", tokens_negative)
    def test_get_memes_negative_auth(self, get_memes, invalid_token):
    ...
    def test_get_meme_id_negative(self, get_meme_id, check_token, invalid_meme_id):
    ...
    @pytest.mark.parametrize("invalid_token", tokens_negative)
    def test_get_meme_id_negative_auth(self, get_meme_id, check_token, invalid_token):
    ...
    def test_post_meme_negative(self, post_meme, check_token, body):
    ...
    @pytest.mark.parametrize("invalid_token", tokens_negative)
    def test_post_meme_negative_auth(self, post_meme, invalid_token):
    ...
    def test_try_put_meme_id_negative(self, put_meme_id, check_token, create_test_meme_then_delete, new_body):
    ...
    @pytest.mark.parametrize("invalid_token", tokens_negative)
    def test_try_put_meme_id_negative_auth(self, put_meme_id, invalid_token, create_test_meme_then_delete):
    ...
    @pytest.mark.parametrize("invalid_meme_id", memes_negative)
    def test_try_put_meme_id_negative(self, put_meme_id, check_token, invalid_meme_id):
    ...
    @pytest.mark.parametrize("invalid_meme_id", memes_negative)
    def test_delete_meme_id_negative(self, delete_meme_id, check_token, invalid_meme_id):
    ...
    @pytest.mark.parametrize("invalid_token", tokens_negative)
    def test_delete_meme_id_negative_auth(self, delete_meme_id, create_test_meme_then_delete, invalid_token):
